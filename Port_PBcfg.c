...
const Port_ConfigType Port_Configuration{
    ...
    PORT_PortF,  PORT_Pin1, PORT_PIN_OUT, OFF, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_DIO STD_ON,STD_ON, /*RED_LED*/
    ...
    PORT_PortF,  PORT_Pin4, PORT_PIN_IN, PULL_UP, PORT_PIN_LEVEL_LOW, PORT_PIN_MODE_DIO, STD_ON,STD_ON /*SWITCH_1*/
